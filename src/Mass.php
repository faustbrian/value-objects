...
final readonly class Mass
{
    ...
    private function __construct(
        public float $data,
        /**
         * @phpstan-ignore-next-line class.notFound -- MassUnit enum provided by consuming application
         */
    ...
    {
        /** @phpstan-ignore-next-line class.notFound -- MassUnitConverter provided by consuming application */
