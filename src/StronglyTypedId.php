...
abstract readonly class StronglyTypedId implements Stringable
{
     ...
     */
    /**
     * @phpstan-ignore-next-line generics.notGeneric -- Illuminate\Database\Eloquent\Casts\Attribute does not support generics in older Laravel versions
     */
    public static function asEloquentAttribute(): Attribute
    {
        return Attribute::make(
            get: fn (?string $value): ?static => $value !== null && $value !== '' && $value !== '0' ? static::fromString($value) : null,
