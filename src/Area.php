...
final readonly class Area
{
    ...
    private function __construct(
        public float $data,
        /**
         * @phpstan-ignore-next-line class.notFound -- AreaUnit enum provided by consuming application
         */
    ...
    {
        /** @phpstan-ignore-next-line class.notFound -- AreaUnitConverter provided by consuming application */
