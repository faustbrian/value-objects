...
/**
 * Represents a volume measurement in cubic meters (m³).
 *
 ...
 */
final class CubicMeter extends AbstractDataTransferObject implements Stringable
{
    /**
     * Create a new cubic meter volume instance.
     *
     * @param float $volume   Total calculated volume in cubic meters (length × width × height)
     * @param float $length   Length dimension in meters used in the volume calculation
     * @param float $width    Width dimension in meters used in the volume calculation
     * @param float $height   Height dimension in meters used in the volume calculation
     ...
     *
     * @return self New cubic meter instance
     */
     ...
     *
     * Converts decimeter measurements to meters (÷10) before calculating volume.
     *
     ...
     * @throws InvalidDimensionsException When any dimension is zero or empty
     *
     * @return self New cubic meter instance with converted dimensions
     */
     ...
     *
     * Converts centimeter measurements to meters (÷100) before calculating volume.
     *
    ...
    /**
     * Get the calculated volume in cubic meters.
     *
