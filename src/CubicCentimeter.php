...
/**
 * Represents a volume measurement in cubic centimeters (cm³).
 *
 ...
 */
final class CubicCentimeter extends AbstractDataTransferObject implements Stringable
{
    /**
     * Create a new cubic centimeter volume instance.
     *
     * @param float $volume   Total calculated volume in cubic centimeters (length × width × height)
     * @param float $length   Length dimension in centimeters used in the volume calculation
     * @param float $width    Width dimension in centimeters used in the volume calculation
     * @param float $height   Height dimension in centimeters used in the volume calculation
     ...
     *
     * Converts meter measurements to centimeters (×100) before calculating volume.
     *
     ...
     *
     * @return self New cubic centimeter instance with converted dimensions
     */
    public static function createFromMeter(float $length, float $width, float $height, ?int $decimals = null): self
    {
        ...
        return self::createFromCentimeter($length, $width, $height, $decimals ?? 0);
    }
     ...
     * @throws InvalidDimensionsException When any dimension is zero or empty
     *
     * @return self New cubic centimeter instance
     */
     ...
     *
     * Converts decimeter measurements to centimeters (×10) before calculating volume.
     *
    ...
    /**
     * Get the calculated volume in cubic centimeters.
     *
     ...
     *
     * @return float Width in centimeters
     */
