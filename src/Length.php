...
final readonly class Length
{
    ...
    private function __construct(
        public float $data,
        /**
         * @phpstan-ignore-next-line class.notFound -- LengthUnit enum provided by consuming application
         */
    ...
    {
        /** @phpstan-ignore-next-line class.notFound -- LengthUnitConverter provided by consuming application */
