...
final readonly class Volume
{
    ...
    private function __construct(
        public float $data,
        /**
         * @phpstan-ignore-next-line class.notFound -- VolumeUnit enum provided by consuming application
         */
    ...
    {
        /** @phpstan-ignore-next-line class.notFound -- VolumeUnitConverter provided by consuming application */
